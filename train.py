...
def parse_args(args):
    ...
    oid_parser.add_argument('main_dir', help='Path to dataset directory.', default=os.path.join('data', 'training'))
    ...
    parser.add_argument('--steps',           help='Number of steps per epoch.', type=int, default=50)
